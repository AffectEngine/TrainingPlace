...
from .views import inde, edit, delete, contact, rubrics, first_model_inline_formset, PersonRegView, \
    FirstModelByRubricViewL, FirstModelDetailView, FirstModelAddView, \
...
urlpatterns = [
    ...
    path('rubricsID/<int:rubric_id>/', first_model_inline_formset, name='rubricsID'),
